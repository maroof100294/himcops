...
class EventPerformanceApplicantAddressDetailsForm extends StatefulWidget {
  ...
  const EventPerformanceApplicantAddressDetailsForm({
    super.key,
  ...
  _EventPerformanceApplicantAddressDetailsFormState createState() =>
      _EventPerformanceApplicantAddressDetailsFormState();
}

class _EventPerformanceApplicantAddressDetailsFormState
    extends State<EventPerformanceApplicantAddressDetailsForm> {
