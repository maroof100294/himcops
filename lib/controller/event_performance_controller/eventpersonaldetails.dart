...
class EventPerformanceApplicantPersonalDetailsForm extends StatefulWidget {
  ...
  const EventPerformanceApplicantPersonalDetailsForm({
    super.key,
  ...
  _EventPerformanceApplicantPersonalDetailsFormState createState() =>
      _EventPerformanceApplicantPersonalDetailsFormState();
}
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 10),
        TextFormField(
          controller: widget.organizationNameController,
          decoration: InputDecoration(
