...
class ProtestApplicantPersonalDetailsForm extends StatefulWidget {
  ...
  const ProtestApplicantPersonalDetailsForm({
    super.key,
  ...
  _ProtestApplicantPersonalDetailsFormState createState() =>
      _ProtestApplicantPersonalDetailsFormState();
}

class _ProtestApplicantPersonalDetailsFormState
    extends State<ProtestApplicantPersonalDetailsForm> {
