...
class ProtestApplicantOrganizationDetailsForm extends StatefulWidget {
  ...
  const ProtestApplicantOrganizationDetailsForm({
    super.key,
  ...
  _ProtestApplicantOrganizationDetailsFormState createState() =>
      _ProtestApplicantOrganizationDetailsFormState();
}

class _ProtestApplicantOrganizationDetailsFormState
    extends State<ProtestApplicantOrganizationDetailsForm> {
      int? selectedStateId;
