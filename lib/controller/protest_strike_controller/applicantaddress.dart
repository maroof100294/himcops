...
class ProtestApplicantAddressDetailsForm extends StatefulWidget {
  ...
  const ProtestApplicantAddressDetailsForm({
    super.key,
  ...
  _ProtestApplicantAddressDetailsFormState createState() =>
      _ProtestApplicantAddressDetailsFormState();
}

class _ProtestApplicantAddressDetailsFormState
    extends State<ProtestApplicantAddressDetailsForm> {
