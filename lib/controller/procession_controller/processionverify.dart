  ...
  Future<void> _registerUser() async {
    ...
    try {
      ...
      final payloadBody = {
        ...
        "processionMajorParticipantStateCd": participantState,
        //  List.filled(participantNames.length, selectedStateName),
        "processionMajorParticipantDistrictCd": participantDistrict,
        // List.filled(participantNames.length, selectedDistrictName),
        "processionMajorParticipantVillage": participantAddress,
        "processionMajorParticipantPoliceStationCd": participantPs,
