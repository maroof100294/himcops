...
class EventPerformanceStatusPage extends StatefulWidget {
  ...
  @override
  State<EventPerformanceStatusPage> createState() => _EventPerformanceStatusPageState();
}

class _EventPerformanceStatusPageState extends State<EventPerformanceStatusPage> {
  @override
